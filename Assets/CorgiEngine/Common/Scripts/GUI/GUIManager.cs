...
{	
	...
	public class GUIManager : MMSingleton<GUIManager>, MMEventListener<LevelNameEvent>, MMEventListener<ControlsModeEvent>
	{
		...
		/// whether the jetpack bar should visually update as fuel changes at runtime
		[Tooltip("If false, jetpack fuel still works, but the jetpack bar won't change visually at runtime.")]
		public bool UpdateJetpackBarsAtRuntime = false;
