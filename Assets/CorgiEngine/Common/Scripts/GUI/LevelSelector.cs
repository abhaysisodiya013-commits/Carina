...
namespace MoreMountains.CorgiEngine
{
	...
	public class LevelSelector : MonoBehaviour
	{
		...
		/// <summary>
		/// Loads the configured level directly, bypassing the LevelManager loading screen.
		/// </summary>
		public virtual void GoToLevelDirect()
		{
		...
		/// <summary>
		/// Restarts the current level directly, bypassing the LevelManager loading screen.
		/// </summary>
		public virtual void RestartLevelDirect()
		{
