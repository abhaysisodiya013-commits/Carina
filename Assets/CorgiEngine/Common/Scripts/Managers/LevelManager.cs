...
namespace MoreMountains.CorgiEngine
{
	...
	public class LevelManager : MMSingleton<LevelManager>, MMEventListener<CorgiEngineEvent>
	{
		...
		/// duration between the final death of the main character and the game over scene
		[Tooltip("duration between the final death of the main character and the game over scene")]
		...
		/// <summary>
		/// Waits briefly after the final death before opening the game over scene.
		/// </summary>
		protected virtual IEnumerator GameOverCo()
		{
