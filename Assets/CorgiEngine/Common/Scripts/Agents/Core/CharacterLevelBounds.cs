...
namespace MoreMountains.CorgiEngine
{
    ...
    public class CharacterLevelBounds : MonoBehaviour
    {
        ...
        public BoundsBehavior Top = BoundsBehavior.Nothing;
        ...
        public virtual void LateUpdate()
        {
            ...
            {
                // top bound is intentionally not enforced as a constrain here,
                // so the player can keep moving upward through the map.
                // if you still want a hard top limit, set Top to Kill.
                if ((Top == BoundsBehavior.Kill) && (_controller.ColliderTopPosition.y > _bounds.max.y))
                {
