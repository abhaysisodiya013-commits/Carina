...
{	
	...
	public class Water : MonoBehaviour 
	{
		...
		protected virtual void OnTriggerEnter2D(Collider2D collider)
		{
			...
			if (CharacterCanSwim(_characterSwim))
			{
		...
		protected virtual bool CharacterCanSwim(CharacterSwim characterSwim)
		{
			return (characterSwim != null) && characterSwim.isActiveAndEnabled && characterSwim.AbilityPermitted;
		}
	}
}
